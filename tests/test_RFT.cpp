...
BOOST_AUTO_TEST_CASE(ICD_Setting_No_ICD)
{
    const auto xSEG = readWriteSegmentRFTData();
...
BOOST_AUTO_TEST_CASE(ICD_Strength_No_ICD)
{
    const auto xSEG = readWriteSegmentRFTData();
...
BOOST_AUTO_TEST_CASE(ICD_Length_No_ICD)
{
    const auto xSEG = readWriteSegmentRFTData();
...
BOOST_AUTO_TEST_CASE(ICD_Max_Flow_Rate_No_ICD)
{
    const auto xSEG = readWriteSegmentRFTData();
...
BOOST_AUTO_TEST_CASE(ICD_Flow_Scaling_No_ICD)
{
    const auto xSEG = readWriteSegmentRFTData();
