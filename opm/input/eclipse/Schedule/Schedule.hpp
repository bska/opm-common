...
namespace Opm {
    ...
    public:
        ...
        /// List of well lists with structural changes since previous report step.
        ///
        /// Structural changes in this context include
        ///
        ...
        /// restart step in a restarted simulation run.
        ///
        /// \return List of well list names, including leading asterisk, at
        /// time \p reportStep with structural changes since the previous
        /// report step.
        std::vector<std::string>
        changedWellLists(std::size_t reportStep,
                         std::size_t initialStep = 0) const;
