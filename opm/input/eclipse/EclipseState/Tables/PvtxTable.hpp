...
namespace Opm {
    ...
    public:
        ...
        /// One sub-table for each composition (PVTO) or pressure (PVTG)
        /// node.
        auto cbegin() const { return this->m_underSaturatedTables.begin(); }

        /// End of sequence of sub-tables.
        auto end() const { return this->m_underSaturatedTables.end(); }

        /// End of sequence of sub-tables.
        auto cend() const { return this->m_underSaturatedTables.end(); }
    ...
    private:
        ...
        ///
        /// Inserts values into \c m_underSaturatedTables.  This is first
        /// main stage of init().
        ///
        /// \param[in] keyword Input PVTx table data.  Typically containing
        /// PVTO or PVTG tables.
