...
Opm::RestartIO::RestartOutputManager::actions() const
{
    ...
    const auto actionxData = Helpers::createAggregateActionxData
        (this->schedule_,
...
Opm::RestartIO::RestartOutputManager::tracerArrays() const
{
    ...
    // Note: We can't use writeSolutionValues() here since we need to interleave header
    // writing with array writing.
