    ...
    namespace LateralBranch {
        ...
        private:
            struct KickOffPoint
            {
                ...
                bool operator<(const KickOffPoint& that) const
                {
                    ...
                    return std::tie(this->outlet, this->branch)
                        >  std::tie(that .outlet, that .branch);
                }
            };
            ...
            std::priority_queue<KickOffPoint> kickOffPoints_{};
